...
<body>
    ...
    <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
        <h3 class="text-white text-center mb-4">Products Available in Daraz Database</h3>
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        for (var i = 0; i < productList.length; i++) {
                            ...
                            html += '<div class="clearfix mb-3"><span class="float-start badge rounded-pill bg-info">' + product.Category + '</span><span class="float-end price-hp">PKR' + product.Price + '</span> </div>';
